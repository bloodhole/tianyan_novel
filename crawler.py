...
logger.info('You can find this written in tianyan.log')
...
class Book:
    ...
    def get_local_toc(self):
        logger.info("Loading Local TOC of Book" +
    ...
    def save_local_toc(self):
        f_toc = open('./novel/' + self.name + '+' +
                     self.author + '.json', 'w', encoding='utf-8')
    ...
    def download(self):
        f_book = open('./novel/' + self.name + '+' +
                      self.author + '.txt', 'a', encoding='utf-8')
